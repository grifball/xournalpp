...
const char* TOOLBAR_INI_HEADER =
        ...
        "\n"
        " Edit: CUT,COPY,PASTE,SEARCH,UNDO,REDO,INSERT_NEW_PAGE,BOOKMARK_PAGE\n"
        "\n"
        " Navigation: GOTO_FIRST,GOTO_BACK,GOTO_NEXT,GOTO_LAST,GOTO_NEXT_ANNOTATED_PAGE,GOTO_NEXT_BOOKMARKED_PAGE,GOTO_PREVIOUS_BOOKMARKED_PAGE\n"
        "\n"
